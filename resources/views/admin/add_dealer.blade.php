        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <strong style="margin-left: 35%;">New Dealer</strong>
            </div>
            ...
            <div class="card-body px-0 pt-0 pb-2" style="width: 70%;margin-left: 14%;">
              <div class="table-responsive p-0">
                ...
                <form id="product_dealer" action="{{url('/admin/dealer')}}"  method="POST" >
                                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                  ...
                                  <div class="form-group" >
                                   <label for="City">Address </label><br>
                                    <input type="text" class="form-control"  name="address" placeholder="City Address" required="" >
                                  </div>
                                  <div class="form-group" >
