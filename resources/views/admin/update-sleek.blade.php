          ...
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2" style="width: 70%;margin-left: 14%;">
              <div class="table-responsive p-0">
                           ...
                           <form  method="POST" action='{{url("/admin/update-sleek/")}}' enctype="multipart/form-data" >
                                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                <input type="hidden" class="product_id_thrd" name="product_id" id="product_id_thrd" value="{{$product->id}}" />
                                @if($product_details->sleek_img != "")
                                <img src='{{url("/images/$product_details->sleek_img")}}' class="card-img-top mx-auto" alt="{{ $product_details->sleek_img }}">
                                @endif
                                 <label for="Mobile Sleek">Sleek Info </label><br>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file"  name="sleek_imgs" placeholder="mobile Sleek images here" >
                                </div>
                                @if($product_details->sleek_img != "")
                                <img src='{{url("/images/$product_details->overview_img")}}' class="card-img-top mx-auto" alt="{{ $product_details->overview_img }}">
                                @endif
                                 <label for="Mobile Sleek">Overview Info </label><br>
                                ...
                                <div class="form-group">
                                    <label for="Mobile Sleek">Overview Image </label><br>
                                    <input type="file"  name="overview_imgs" placeholder="mobile Overview images here" >
                                </div>
