            ...
            <div class="card-body px-0 pt-0 pb-2" style="width: 70%;margin-left: 14%;">
              <div class="table-responsive p-0">
                <form  method="POST" action='{{url("/admin/update-product/")}}'  enctype="multipart/form-data" style="display: block" >
                    ...
                    <input type="number" min="0" class="form-control" name="price" placeholder="mobile Price here" value="{{$product->price}}" required="">
                    </div>
                                
                    <div class="form-group">
                    <label for="Mobile Details">Details </label>
                    <textarea class="form-control" name="details" required="" rows="5" placeholder="Mobile Description Here">{{$product->details}}</textarea>
                    </div>
                    <div class="form-group">
                    <label for="Mobile Description">Description </label>
                    <textarea class="form-control" name="description" required="" rows="5" placeholder="Mobile Description Here">{{$product->description}}</textarea>
                    </div>
                    <img src='{{url("/images/$product->image_path")}}' class="img img-responsive">
                    <div class="form-group">
                      <label for="Mobile Image">Mobile Image </label><br>
                      <input type="file" min="0"  name="image" placeholder="mobile Description here" >
                    </div>
