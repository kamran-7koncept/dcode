        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <strong style="margin-left: 35%;">Update Product Colors</strong>
            </div>
            ...
            <div class="card-body px-0 pt-0 pb-2" style="width: 70%;margin-left: 14%;">
              <div class="table-responsive p-0">
                           ...
                           <form action='{{url("/admin/update-colors/")}}' method="POST" enctype="multipart/form-data" >
                                ...
                                <input type="hidden" class="product_id_thrd" name="product_id" id="product_id_thrd" value="" />
                                 ...
                                 @foreach($colors as $color)
                                    ...
                                    <input type="text" class="form-control"  name="color_name[]" placeholder="Mobile Color" required="" value="{{$color->color_name}}" multiple>
                                    <input type="hidden" name="ids[]" value="{{$color->color_id}}">
                                    </div>
                                    @endforeach
                                ...
                                <div class="form-group">
                                    <label for="Mobile Sleek">Color Images </label><br>
