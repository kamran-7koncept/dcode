        ...
        <div class="col-12">
                  ...
                  <thead>
                    <tr class="header">
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Product</th>
                       <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Background</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nname</th>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src='{{url("/images/$slider->product_img")}}' class="avatar avatar-sm rounded-circle me-2">
                          </div>
                          <!-- <div class="my-auto">
                      ...
                      <td>
                        <div class="d-flex px-2">
                          <div>
                            <img src='{{url("/images/$slider->background_img")}}' class="avatar avatar-sm rounded-circle me-2">
                          </div>
                          
                        </div>
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0">{{$slider->product_name}}</p>
                      </td>
                      <td style="white-space:unset;">
                        <span class="text-xs font-weight-bold">{{$slider->description}}</span>
                      </td>
                        
                      <td class="align-middle">
     
                    <form method="POST" action='{{url("/admin/update-slider")}}'>
                     @method('PUT')
                     @csrf
                       <input type="hidden" name="slider_id" value="{{$slider->slider_id}}">
                      <div class="dropdown ">
                        <button type="submit" class="btn btn-info btn-icon-split" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="icon text-white-50">
         ...
         <!--   <div class="card-body px-0 pt-0 pb-2" style="width: 70%;margin-left: 14%;">
              <div class="table-responsive p-0">
                ...
                <form id="product_dealer" action="{{url('/admin/sliders')}}"  method="POST" >
