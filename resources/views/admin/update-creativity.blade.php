        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <strong style="margin-left: 35%;">Update Products</strong>
            </div>
            ...
            <div class="card-body px-0 pt-0 pb-2" style="width: 70%;margin-left: 14%;">
              <div class="table-responsive p-0">
                           ...
                           <form method="POST" action='{{url("/admin/update-creativity/")}}' enctype="multipart/form-data" >
                                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                <input type="hidden" name="product_id" value="{{$product->id}}" />
                                <div class="container">
                                  <div class="row">
                                     @foreach($creativity as $image)
                                     <input type="hidden" name="ids[]" value="{{$image->creativity_id }}">
                                <div class="col-sm-6" >
                                  <img style="width: 200px;height: 200px" src='{{url("/images/$image->creativity_img")}}' class="img img-responsive">
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="Mobile Sleek">Cretivity Image<small>(Only 2 images )</small> </label><br>
